...
namespace TextMeshDOTS.HarfBuzz.Bitmap
{
    ...
    */
    internal static class AntiAliasedRasterizerTextMeshDOTS
    {
        ...
        public static void RasterizeAndBlend<T>(ref DrawData drawData, NativeArray<ColorBGRA> textureData, T pattern, PaintCompositeMode mode, BBox clipRect, bool invert = false) where T : IPattern
        {
            PaintUtils.rasterizeCOLRMarker.Begin();
            var edges = drawData.edges;
            var contourIDs = drawData.contourIDs;
