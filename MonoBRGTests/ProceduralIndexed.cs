...
public unsafe class ProceduralIndexed : MonoBehaviour
{
    public Mesh mesh;
    ...
    void Start()
    {
        ...
        _indexBuffer = new GraphicsBuffer(GraphicsBuffer.Target.Index, indices.Length, 4);
        ...
        {
            positions[i] = meshVertices[i];
            normals[i] = meshNormals[i];
            tangents[i] = meshTangents[i];
        }
        ...
        _elementsPerDraw = (uint)vertexCount;
        #endregion
