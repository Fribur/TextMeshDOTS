...
namespace TextMeshDOTS.Rendering
{
    ...
    public partial struct TextRendererInitializeSystem : ISystem
    {
        ...
        {
            m_newGlyphsQuery = QueryBuilder().WithPresent<MaterialMeshInfo, RenderBounds>().WithAny<RenderGlyph, AnimatedRenderGlyph>().WithAbsent<PreviousRenderGlyph>().WithOptions(
