...
namespace TextMeshDOTS.Authoring
{
    ...
    // Use this utility to get the information required for spawning TextRenderer at runtime via FontRequest. See
    // RuntimeSpawner/RuntimeSingleFontTextRendererSpawner and
    // RuntimeSpawner/RuntimeMultiFontTextRendererSpawner
    // Drag and drop a font object into the font field. This utility enumerates all faces in collection fonts
    // (.ttc) and all named instances in variable fonts, populating FontFaceInfo entries for each.
