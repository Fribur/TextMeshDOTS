...
void SampleGlyph_float(int VertexID, int BaseIndex, int GlyphCount, out float3 Position, out float3 Normal, out float3 Tangent, out float4 UVA, out float2 UVB, out float4 Color)
{
    Position = (float3) 0;
    Normal = (float3) 0;
    Tangent = (float3) 0;
